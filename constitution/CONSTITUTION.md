# tool-fillgen Constitution

この文書は、tool-fillgen の開発組織における最上位 contract です。
...
tool-fillgen の開発組織の目的は current procedure への服従ではありません。
...
This repository owns the Fillgen source-only React component library. Host applications consume the source but do not own its parser, renderer, or editor implementation state.
